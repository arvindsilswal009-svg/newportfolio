         ...
         <section className="projects" id="projects">
          <div className="max-width">
            ...
            <div className="carousel owl-carousel">
              <div className="card">
                <div className="box">
                 <img src={process.env.PUBLIC_URL + "/images/calculator.jpg"} alt="" />
                ...
                <div className="card">
                <div className="box">
                  <img src={process.env.PUBLIC_URL + "/images/weatherapp.jpg"} alt="" />
              ...
              <div className="card">
                <div className="box">
                 <img src={process.env.PUBLIC_URL + "/images/portfolio.jpg"} alt="" />
                  <div className="text">Portfolio</div>
                  <p>Here is my portfolio.</p>
      
                              <a className="btn" href=" https://github.com/arvindsilswal009-svg/newportfolio">Code Link</a>
